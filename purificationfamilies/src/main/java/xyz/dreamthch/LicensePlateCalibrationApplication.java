...
public class LicensePlateCalibrationApplication {
    ...
    private static final LicensePlateCalibrationmMapper mapper = new LicensePlateCalibrationmImpl();
    ...
    public static void main(String[] args){
        ...
        for (File file : files) {
            ...
            if (plateNumberStr != null) {
                Map<String, Integer> map = mapper.getGenerateConfigurationFiles(plateDataList);
